...
CREATE INDEX idx_producto_nombre_activo ON producto(nombre) WHERE eliminado = FALSE;
CREATE INDEX idx_categoria_activo ON categoria(id) WHERE eliminado = FALSE;
CREATE INDEX idx_usuario_activo ON usuario(id) WHERE eliminado = FALSE;